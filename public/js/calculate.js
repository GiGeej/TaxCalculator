async function calculate() {
  ...
  for(i =0; i < count; i ++){
    ...
    naEl.innerHTML = gaEl - mediEl.innerHTML - mediEl.innerHTML - taxEl.innerHTML;
  }

//   for(i = 0; i < count; i++){
//     let grossAnnual = document.getElementById("gross-annual-"+[i]).innerHTML;
//     let medicareEl = document.getElementById("medicare-payment"[i]);
//     const taxEl = document.getElementById("tax-payment-1");
//     const netAnnualEl = document.getElementById("net-annual-1");
  
//   medicareEl.innerHTML = grossAnnual * 0.02;
//   taxEl.innerHTML = taxOwed(grossAnnual);
//   netAnnualEl.innerHTML = grossAnnual - medicareEl.innerHTML - taxEl.innerHTML;
//   // netAnnualEl.innerHTML = grossAnnual;
//   }
  }
...
const taxOwed = (grossAnnual) => {
    ...
    const taxOwed = (grossAnnual - tax[0].threshold) * tax[0].taxPercent + tax[0].taxLump;
    return taxOwed;
}
